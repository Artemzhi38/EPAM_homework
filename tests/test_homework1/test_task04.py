...
from homeworks.homework1.task04 import opt_check_sum_of_four
...
def test_n_is_2_case():
    ...
    c = [0, -1]
    d = [0, -1]
    assert opt_check_sum_of_four(a, b, c, d) == 6
...
def test_only_positive_case():
    ...
    c = [1, 1, 1, 1, 1]
    d = [1, 1, 1, 1, 1]
    assert opt_check_sum_of_four(a, b, c, d) == 0
...
def test_n_is_10_worst_case():
    ...
    for i in range(100):
        ...
        c.append(0)
        d.append(0)
    assert opt_check_sum_of_four(a, b, c, d) == 100000000
